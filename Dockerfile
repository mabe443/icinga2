...
RUN mkdir -p /usr/local/share/icingaweb2/modules/ \
    ...
    && wget -q --no-cookies -O - "https://github.com/Mikesch-mp/icingaweb2-module-grafana/archive/v1.4.2.tar.gz" \
    | tar xfz - --strip-components=1 --directory=/usr/local/share/icingaweb2/modules/grafana \
    && true
